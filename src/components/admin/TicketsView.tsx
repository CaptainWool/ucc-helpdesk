...
const TicketsView: React.FC<TicketsViewProps> = ({
    ...
    const getSLAStatus = (deadline: string | null | undefined, status: string) => {
            ...
            <Card className="tickets-list-card">
                <div className="table-responsive">
                    <table className="tickets-table">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select-all-tickets" name="select-all-tickets" aria-label="Select all tickets" checked={tickets.length > 0 && selectedTicketIds.length === tickets.length} onChange={toggleSelectAll} /></th>
                                <th>Subject</th>
                                <th>Student</th>
                                <th>SLA / Created</th>
                                <th>Status</th>
                                                ...
                                                <div className="action-btns">
                                                    ...
                                                    {(profile?.role === 'super_admin' || profile?.role === 'agent') && (
                                                        <Button
                                                            ...
                                                            onClick={() => ticket.student_id_ref && onImpersonate(ticket.student_id_ref)}
                                                        >
                                                            <UserIcon size={14} />
                                                        </Button>
                                                    )}

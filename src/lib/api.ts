import { TicketSchema, UserSchema, FAQSchema } from './schemas';
import { validate } from './validation';
import { z } from 'zod';
import { User, Ticket, FAQ, Stats } from '../types';
...
export const api = {
    auth: {
        ...
        requestReset: async (data: any): Promise<any> => {
        ...
        verifyToken: async (data: any): Promise<any> => {
        ...
        completeReset: async (data: any): Promise<any> => {
        ...
        getUsers: async (role?: string, email?: string): Promise<User[]> => {
            ...
            return validate(z.array(UserSchema), data, 'auth.getUsers');
        },
    ...
    faq: {
        ...
        create: async (data: any): Promise<FAQ> => {
        ...
        update: async (id: string, data: any): Promise<FAQ> => {
        ...
        trackHelpfulness: async (id: string, helpful: boolean): Promise<any> => {
    ...
    messages: {
        list: async (ticketId: string): Promise<any[]> => {
            const res = await fetch(`${API_URL}/tickets/${ticketId}/messages`, { headers: getHeaders() });
            return handleResponse(res);
        },
        create: async (ticketId: string, content: string, senderRole: string, attachment?: File): Promise<any> => {
            let body;
    ...
    system: {
        ...
        moderateUser: async (id: string, data: any): Promise<any> => {
        ...
        cleanupTickets: async (): Promise<any> => {
